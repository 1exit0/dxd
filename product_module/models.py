...
class ProductCategory(models.Model):
    ...
    parent = models.ForeignKey('ProductCategory', on_delete=models.CASCADE, null=True, blank=True,
                               related_name='sub_categories', verbose_name='دسته بندی والد')
...
class Product(models.Model):
    ...
    # افزودن فیلدهای ویژگی‌ها
    processor_type = models.CharField(max_length=50, blank=True, null=True, verbose_name='نوع پردازنده')
    internal_memory = models.IntegerField(blank=True, null=True, verbose_name='حافظه داخلی')
    ram = models.IntegerField(blank=True, null=True, verbose_name='حافظه RAM')
    display_size = models.FloatField(blank=True, null=True, verbose_name='سایز صفحه نمایش')
    rear_camera = models.CharField(max_length=100, blank=True, null=True, verbose_name='دوربین اصلی')
    battery_capacity = models.IntegerField(blank=True, null=True, verbose_name='ظرفیت باتری')
    warranty = models.TextField(max_length=256, verbose_name='گارانتی')
